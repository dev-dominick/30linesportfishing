      ...
      <List>
        {navItems.map((navItems, index) => (
          <ListItem key={index} disablePadding>
            <ListItemButton href={navItems.href} sx={{ textAlign: "center" }}>
    ...
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar component="nav" sx={{ backgroundColor: "grey" }}>
        <Toolbar>
          ...
          >
            {navItems.map((navItems, index) => (
              <Button key={index} href={navItems.href} sx={{ color: "#fff" }}>
                {navItems.name}
              </Button>
            ))}
          </Box>
          ...
          >
            <IconButton sx={{ fontSize: "large", color: "white" }}>
              <FacebookIcon />
            </IconButton>
            <IconButton sx={{ fontSize: "large", color: "white" }}>
              <InstagramIcon />
